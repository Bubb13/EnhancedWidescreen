...
CUIPanel::type_GetControl CUIPanel::p_GetControl;
...
CChitin::type_Original_ToggleFullscreen CChitin::p_Original_ToggleFullscreen;
...
void InitBindingsInternal() {
	...
	attemptFillPointer(TEXT("CUIPanel::GetControl"), CUIPanel::p_GetControl);
	...
	attemptFillPointer(TEXT("CChitin::Original_ToggleFullscreen"), CChitin::p_Original_ToggleFullscreen);
